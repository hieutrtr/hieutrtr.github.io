...
Nguyên tắc cốt lõi Anthropic nhấn mạnh: **bắt đầu ở level lowest còn hoạt động được và chỉ thêm phức tạp khi hiệu quả cải thiện đo được.** Nguyên tắc này cần nhớ khi đánh giá những platform mới mặc định chọn kiến trúc "agent đầy đủ".
